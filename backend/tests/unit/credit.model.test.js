...
describe('Modelo Credit -> Crédito de Inversión / Expansión', () => {
  ...
  it('debería crear correctamente un crédito de inversión con subesquema completo', async () => {
    ...
    const creditData = {
      ...
      estatutoSocial: 'link1',
      comprobanteDomFiscal: 'link2',
      actaAutoridades: 'link3',
      inscripcionFiscal: 'link4',
      certificadoPyme: 'link5',
      dniRepLegal: 'link6',
      ddjjBeneficiario: 'link7',
